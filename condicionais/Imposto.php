...
if ($Imposto <= 2259.20) {
    ...
    echo "Seu imposto é de ". number_format($resultado, 2);
}
elseif ($Imposto >= 2826.66 && $Imposto <= 3751.05) {
    $resultado1 = ($Imposto * 0.15) - 394.16;
    echo "Seu imposto é de ". number_format($resultado1, 2);
}   
elseif ($Imposto >= 3751.06 && $Imposto <= 4664.68) {
    $resultado2 = ($Imposto * 0.225) - 675.49;
    echo "Seu imposto é de ". number_format($resultado2, 2);
}
elseif ($Imposto > 4644.68) {
    $resultado3 = ($Imposto * 0.275) - 908.73;
    echo "Seu imposto é de ". number_format($resultado3, 2);
}
